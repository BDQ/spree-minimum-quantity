...
desc 'Generate documentation for the minimum_quantity extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'MinimumQuantityExtension'
...
desc 'Test the minimum_quantity extension.'
...
namespace :test do
  desc 'Functional test the minimum_quantity extension.'
  ...
  desc 'Unit test the minimum_quantity extension.'
